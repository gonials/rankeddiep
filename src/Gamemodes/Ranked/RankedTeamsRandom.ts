...
import AbstractRankedArena from "./AbstractRanked";
...
export default class RankedTeamsRandomArena extends AbstractRankedArena {
    static override GAMEMODE_ID: string = "ranked-random";
