...
import Minion, { MinionBarrelDefinition } from "./Projectile/Minion";
    ...
    public shoot() {
        ...
        switch (this.definition.bullet.type) {
            ...
            case 'swarm':
                ...
                break;
            case 'minion':
                const definition = (this.definition.bullet.barrels || MinionBarrelDefinition)
                new Minion(this, this.tank, tankDefinition, angle, definition);
            break;
            case 'flame':
