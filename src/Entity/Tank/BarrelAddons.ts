...
export class ReinforcedBarrel extends ObjectEntity {
    /** The barrel that this is placed on. */
    public barrelEntity: Barrel;
...
export class SpawnerLauncher extends ObjectEntity {
    /** The barrel that this trap launcher is placed on. */
    public barrelEntity: Barrel;
...
/** Trap launcher - added onto traps */
export class ReinforcedBarrelAddon extends BarrelAddon {
    /** The actual trap launcher entity */
    public launcherEntity: TrapLauncher;
    ...
    public constructor(owner: Barrel) {
        ...
        this.launcherEntity = new ReinforcedBarrel(owner);
    }
}
...
export class SpawnerAddon extends BarrelAddon {
    ...
    public constructor(owner: Barrel) {
        ...
        this.launcherEntity = new SpawnerLauncher(owner);
    }
}
 ...
 */
export const BarrelAddonById: Record<barrelAddonId, typeof BarrelAddon> = {
    trapLauncher: TrapLauncherAddon,
    spawner: SpawnerAddon,
    reinforcedBarrel: ReinforcedBarrelAddon,
