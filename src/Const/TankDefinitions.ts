...
export type postAddonId = "dompronounced" | "auto5" | "auto3" | "autosmasher" | "spike" | "pronounced" | "smasher" | "landmine" | "autoturret" | "weirdspike" | "auto2" | "auto7" | "autorocket" | "spiesk" | "heavy" | "shotgun" | "dualshot" | "pelletshot";
/** The types of post addons that exist in the game, by their id. */
export type preAddonId = "dombase" | "launcher" | "sniperLauncher" | "heavyLauncher";
...
export type projectileId = "bullet" | "drone" | "trap" | "necrodrone" | "minion" | "skimmer" | "rocket" | "glider" | "swarm" | "flame" | "wall" | "croc";

/** The types of barrel addons that exist in the game */
export type barrelAddonId = "trapLauncher" | "spawner" | "purplebarrel" | "reinforcedBarrel"
...
export interface BulletDefinition {
    ...
    /** Overrides barrel definition for factory drones. */
...
export interface BarrelDefinition {
    ...
    forceFire?: boolean;
    /** Should shoot with right click instead of left click? */
