...
export const host: string = process.env.REGION || "unknown";
...
/** Only used if useSSL is true. */
export const sslOptions = {
  key: "path/to/key.pem",
  cert: "path/to/cert.pem"
}

export const enableVerification: boolean = false;

/** Discord and stats server */
export const API_URL: string | null = null;
/** Discord and stats server */
export const API_KEY: string | null = null;
...
export const factorySpawnChance: number = 0.25;
